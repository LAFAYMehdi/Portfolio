...
Ce projet a été développé dans le cadre de la **SAÉ 1.01** en BUT Informatique : Implémentation d'un besoin client (développement du Pauvocodeur).
...
- **Mathématiques** : Pondération progressive, fenêtrage
...
SEEK_WINDOW        // Fenêtre de recherche pour optimisation
...
- **Optimisation de signal** : Minimisation de la distorsion
